...
/**
 * Protobuf type {@code transactionmetadata.GetImagesRequest}
 */
public  final class GetImagesRequest extends
    com.google.protobuf.GeneratedMessageLite<
        GetImagesRequest, GetImagesRequest.Builder> implements
    // @@protoc_insertion_point(message_implements:transactionmetadata.GetImagesRequest)
  ...
  public static to.bnk.api.transactionmetadata.GetImagesRequest parseFrom(
  ...
  public static to.bnk.api.transactionmetadata.GetImagesRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static to.bnk.api.transactionmetadata.GetImagesRequest parseFrom(java.io.InputStream input)
  ...
  public static to.bnk.api.transactionmetadata.GetImagesRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static to.bnk.api.transactionmetadata.GetImagesRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(to.bnk.api.transactionmetadata.GetImagesRequest prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        to.bnk.api.transactionmetadata.GetImagesRequest, Builder> implements
      // @@protoc_insertion_point(builder_implements:transactionmetadata.GetImagesRequest)
      to.bnk.api.transactionmetadata.GetImagesRequestOrBuilder {
    // Construct using to.bnk.api.transactionmetadata.GetImagesRequest.newBuilder()
    private Builder() {
    ...
    // @@protoc_insertion_point(builder_scope:transactionmetadata.GetImagesRequest)
  }
  @java.lang.Override
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new to.bnk.api.transactionmetadata.GetImagesRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<to.bnk.api.transactionmetadata.GetImagesRequest> parser = PARSER;
        if (parser == null) {
          synchronized (to.bnk.api.transactionmetadata.GetImagesRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<to.bnk.api.transactionmetadata.GetImagesRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  // @@protoc_insertion_point(class_scope:transactionmetadata.GetImagesRequest)
  private static final to.bnk.api.transactionmetadata.GetImagesRequest DEFAULT_INSTANCE;
  static {
  ...
  public static to.bnk.api.transactionmetadata.GetImagesRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
