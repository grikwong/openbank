...
public interface UpdateWhereTagRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:transactionmetadata.UpdateWhereTagRequest)
   ...
   * <code>.transactionmetadata.WhereTag WhereTag = 1[json_name = "where_tag", ctype = STRING, deprecated = false, lazy = false, jstype = JS_NORMAL, weak = false];</code>
   */
  to.bnk.api.transactionmetadata.WhereTag getWhereTag();
