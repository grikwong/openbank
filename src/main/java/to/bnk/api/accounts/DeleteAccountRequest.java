...
public  final class DeleteAccountRequest extends
  ...
  public static to.bnk.api.accounts.DeleteAccountRequest parseFrom(
  ...
  public static to.bnk.api.accounts.DeleteAccountRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static to.bnk.api.accounts.DeleteAccountRequest parseFrom(java.io.InputStream input)
  ...
  public static to.bnk.api.accounts.DeleteAccountRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static to.bnk.api.accounts.DeleteAccountRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(to.bnk.api.accounts.DeleteAccountRequest prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        to.bnk.api.accounts.DeleteAccountRequest, Builder> implements
      // @@protoc_insertion_point(builder_implements:accounts.DeleteAccountRequest)
      to.bnk.api.accounts.DeleteAccountRequestOrBuilder {
    // Construct using to.bnk.api.accounts.DeleteAccountRequest.newBuilder()
    private Builder() {
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new to.bnk.api.accounts.DeleteAccountRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<to.bnk.api.accounts.DeleteAccountRequest> parser = PARSER;
        if (parser == null) {
          synchronized (to.bnk.api.accounts.DeleteAccountRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<to.bnk.api.accounts.DeleteAccountRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final to.bnk.api.accounts.DeleteAccountRequest DEFAULT_INSTANCE;
  static {
  ...
  public static to.bnk.api.accounts.DeleteAccountRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
