...
/**
 * Protobuf type {@code kyc.AddKYCStatusRequest}
 */
public  final class AddKYCStatusRequest extends
    com.google.protobuf.GeneratedMessageLite<
        AddKYCStatusRequest, AddKYCStatusRequest.Builder> implements
    // @@protoc_insertion_point(message_implements:kyc.AddKYCStatusRequest)
    AddKYCStatusRequestOrBuilder {
  private AddKYCStatusRequest() {
    customerID_ = "";
    customerNumber_ = "";
  }
  ...
  public static to.bnk.api.kyc.AddKYCStatusRequest parseFrom(
  ...
  public static to.bnk.api.kyc.AddKYCStatusRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static to.bnk.api.kyc.AddKYCStatusRequest parseFrom(java.io.InputStream input)
  ...
  public static to.bnk.api.kyc.AddKYCStatusRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static to.bnk.api.kyc.AddKYCStatusRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(to.bnk.api.kyc.AddKYCStatusRequest prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        to.bnk.api.kyc.AddKYCStatusRequest, Builder> implements
      // @@protoc_insertion_point(builder_implements:kyc.AddKYCStatusRequest)
      to.bnk.api.kyc.AddKYCStatusRequestOrBuilder {
    // Construct using to.bnk.api.kyc.AddKYCStatusRequest.newBuilder()
    private Builder() {
    ...
    // @@protoc_insertion_point(builder_scope:kyc.AddKYCStatusRequest)
  }
  @java.lang.Override
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new to.bnk.api.kyc.AddKYCStatusRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<to.bnk.api.kyc.AddKYCStatusRequest> parser = PARSER;
        if (parser == null) {
          synchronized (to.bnk.api.kyc.AddKYCStatusRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<to.bnk.api.kyc.AddKYCStatusRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  // @@protoc_insertion_point(class_scope:kyc.AddKYCStatusRequest)
  private static final to.bnk.api.kyc.AddKYCStatusRequest DEFAULT_INSTANCE;
  static {
    AddKYCStatusRequest defaultInstance = new AddKYCStatusRequest();
    // New instances are implicitly immutable so no need to make
    // immutable.
    DEFAULT_INSTANCE = defaultInstance;
    com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
      AddKYCStatusRequest.class, defaultInstance);
  }

  public static to.bnk.api.kyc.AddKYCStatusRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static volatile com.google.protobuf.Parser<AddKYCStatusRequest> PARSER;

  public static com.google.protobuf.Parser<AddKYCStatusRequest> parser() {
